...
module.exports.controller = (app) => {
    ...
    app.post('/reservation/queued', async(req,res) => {
    ...
    app.put('/reservation/queued/:password',(req, res) => {  
    ...
    app.delete('/reservations/queued/:password', (req, res) => {  
    ...
    app.get('/reservation/getqueued/:password', (req,res) => {
