...
export default {
    ...
    methods:{
        ...
        getTable(){
            axios({        
                method: 'get',
                url: 'http://192.168.1.178:5000/reservation/payStat',      
            })        
            .then((response) => {          
        ...
        login() {      
            axios({        
                ...
                url: `http://192.168.1.178:5000/reservation/user/password/${this.password}`,      
        ...
        paystatUpdate(){
            axios({        
                method: 'put',                
                url: `http://192.168.1.178:5000/reservation/payStat/${this.checkedRow[0].password}`,      
