...
var socket = openSocket("http://192.168.1.178:5000");
    ...
    methods: {    
        async updateOrder(){
            ...
            axios({        
                ...
                url: `http://192.168.1.178:5000/reservation/user/addtime/${this.defaultPass}`,      
    ...
    methods:{
        ...
        async removeThing(){         
            await axios({        
                ...
                url: `http://192.168.1.178:5000/reservation/user/${this.defaultPass}`,      
    ...
    methods:{        
        async delRes(){
            ...
            axios({
                ...
                url: `http://192.168.1.178:5000/reservation/user/${this.seat}/${this.table}/${this.password}`          
   ...
   components: {       
    ...
    methods: {  
        ...
        filteredReservations(object){
            ...
            axios({        
                method: 'get',
                url: `http://192.168.1.178:5000/reservation/password/${object}`,      
            })        
            .then((response)=>{ 
